...
Find:    Perform a Multi-Class Classification and complete hyperparameter tuning
		 without the help of sklearn GridSearchCV toolbox
        
Sol'n:   Classical ML --> Use optimized Random Forest classifier
...
Notes:   - This program requires the following libraries to be present in your
         ...
         - Hyperparameter tuning can be completed by comma-separating additional
           parameters within each list shown in lines 51-57
...
import pandas as pd
FeatureData     = 'InputFeatureFile.csv'
OutputData      = 'DesiredOutputClassData.csv'
...
max_features        = ['log2']      # see line 88
max_depth           = [None]        # ...
n_estimators        = [30]          # ...
criterion           = ['gini']      # ...
min_samples_leaf    = [1]           # ...
min_samples_split   = [2]           # ...
bootstrap           = ['True']      # see line 94
...
for row in HyperParamCombos:
    ...
    # Create Binary Confusion Matrix (to gain additional insight into the model)
